...
|-----|---------------|----------------|
|  1  | Legacy        | [![Releases](https://img.shields.io/github/release/openebs/Mayastor/all.svg?style=flat-square)](https://github.com/openebs/cstor-csi/releases/tag/v3.6.0)   |
