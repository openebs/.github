...
Our project is sponsored by these amazing data storage companies and their amazing storage engineering teams. Our orignal founding team continues to guide the project as custodial Maintainers. Major ponsorship is provided via DataCore, Inc (who donates considerable daily Product Dev/Engineering and Product Managment operations rescources to the OpenEBS. Our foudning team was acquired by DataCore, Inc). We also have 100's of amazing individuals, contributors and storage engineers who provide brainstorming ideas, feedback, code reviews and high-quality code to the project.<BR>
