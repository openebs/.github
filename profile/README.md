...
Our project is sponsored by these innovative data storage companies and their amazing storage engineering teams. Our orignal founding team is very passionatye about the product and continues to guide the project as custodian Maintainers. Many of whom contribute from sponsorship through DataCore, Inc (who donates considerable daily Product Dev/Engineering and Product Managment operations rescources to the OpenEBS). We also have 100's of amazing individuals, contributors and engineers who provide brainstorming ideas, feedback, code reviews and lots of high-quality code to the project.<BR>
All who are passionate about storage and Data are welcome here.<BR>
<BR>
