...
```rust
LEGACY consists of Data-Engines that we experimented with early on. These Data-Engines have a number of opensoruce techologies \n embeded inside them, and are a great intro into the world of simple K8s storage services.
